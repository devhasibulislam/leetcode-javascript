 ...
 * Description: A good string has size n, it is alphabetically greater than or equal to s1, it is alphabetically smaller than or equal to s2, and it does not contain the string evil as a substring. Since the answer can be a huge number, return this modulo 109 + 7.
...
function dfs(
  ...
  let [start, end] = [
    left ? s1.charCodeAt(mainTravel) : 97,
    right ? s2.charCodeAt(mainTravel) : 122,
  ];
